...
public class TodoListView {
	...
	public void  todoDetailView() throws IOException{
		...
		int index = Integer.parseInt(br.readLine()); //전달 받은 String 값을 정수형으로 변환해주는 것 
													//IOException이 발생해서 상위로 throws 해줘야함
	...
	/**
	 * 할 일 추가하기(제목, 상세 내용만 입력받음)
	 * 기본이 미완료 이기에 입력받을 필요 x
	 * 등록 한 시간이 등록 날짜이기에 입력받을 필요x
	 * 
	 * @throws IOException
	 */
	...
	public void todoUpdate() throws Exception{
		...
		System.out.println("수정 할 세부  내용 작성 (입력 종료 시 !wq 작성 후 엔터)");
		System.out.println("\n-------------------------------------------------\n");
