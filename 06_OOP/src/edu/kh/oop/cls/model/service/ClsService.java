...
public class ClsService  /*extends Student*/{
	...
	public void ex1() {
		...
		//(default) class 인 TestVO는 import 가 불가(다른 패키지)
...
//		System.out.println(std.v4);
	...
	public void ex2() {
		...
		//schoolName에 경고가 뜨는 이유=> 제대로 작성을 안해서임. (실행은 잘된다..!)
		 ...
		 * -> 프로그램 시작 시 static 이라고 붙은 코드들이 모두 static 영역에 생성되고,
		 * 프로그램이 종료될 때 까지 사라지지 않음(정적)
		 * 그리고, static 영역에 생성된 변수는 어디서든지 공유 가능(공유)
		 * 
		 * 2) 사용방법 : 클래스명.변수명 (ex _ Student.schoolName)
		 * 
		 * 
		 * */
	}
