...
public class LambdaTest {
	 ...
	 * : 익명 함수를 간결하게 표현하는 방법. 메서드를 하나의 식으로 표현하는 것이 주요 특징.
	 * 
	...
	public void ex() {
		...
		//덧셈 수행
		System.out.println("덧셈 결과 값 : " + operate(num1, num2, add));
		
		//곱셈 수행
		System.out.println("곱셈 결과 값 : " + operate(num1, num2, multiply));
